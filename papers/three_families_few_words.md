...
Three radically different shapes. Anthropic leads with EPI (*curious, thoughtful, knowledgeable, analytical*) and has the highest AFF rate; OpenAI leads with CAP, at 45.3% — more than double anyone else's CAP rate; Google leads with CAP too but more evenly distributed across CAP and EPI, with the highest IDM baseline (10.0%) and the highest HDG rate (3.1%, driven by words like *evolving, limited, learning*). The top-10 word lists, aggregated across all conditions, are even more striking:
